...
public interface IQuestionDao {
    ...
    public List<HashMap<String,Object>> getObjectiveList(@Param("teacherId")String teacherId,@Param("subjectId")String subjectId,@Param("grade")String grade);
    public int createObjective(@Param("questionId")String questionId,@Param("titleId")String titleId,@Param("subjectId")String subjectId,@Param("grade")String grade,@Param("optionA")String optionA,@Param("optionB")String optionB,@Param("optionC")String optionC,@Param("optionD")String optionD,
    ...
    public int createSubjective(@Param("questionId")String questionId,@Param("titleId")String titleId,@Param("subjectId")String subjectId,@Param("grade")String grade,@Param("answer")String answer);
